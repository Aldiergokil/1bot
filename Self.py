...
aldier.login(token='EohtVhlhleetUZMY3hu6.fuhmXP7FiLvOyAe2zzTr5G.3s7U1VOxeozjnEV+vP45hUGbF6QPKvUZT9ArH7viOn4=')
aldier.loginResult()
    ...
    try:
	    ...
	    if mid in op.param3:	        
		    ...
		    G = aldier.getGroup(op.param1)
                    if len(G.members) <= wait["memberscancel"]:
                        ...
                        aldier.acceptGroupInvitation(op.param1)
			aldier.sendText(op.param1,"☆Ketik ☞Help☜ Untuk Bantuan☆\n☆Harap Gunakan Dengan Bijak ^_^ ☆")
        ...
        if op.type == 25:
			...
			aldier.sendText(msg.to,"Admin Detected~")
                ...
                aldier.sendMessage(msg)
		aldier.sendText(msg.to,"Itu Majikan Kami (^_^)")
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            aldier.sendText(msg.to,"Admin Aldier Dihapus")
                        except:
                            pass
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                link = ["http://dl.profile.line-cdn.net/0hOg-sF77_EEgQCjx_0-NvHyxPHiVnJBYAaGxbKzVYHCo6MgNLe29cKjENR389alccK2tbJmYOTiw6"]
