...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EoOdK5CCKoUtlg63j0Dd.SB3VnlSeay5u8/Qr+Ptdpq.LCewR+eBZpdeR5++CUL7gzONDQDF+5zwT4VHTytotWk=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EoYCtKsGOBachon8Ada7.mhJ6EgBJ9pWxI8z6B0IvzW.kbzy9aZOqMNDE0fu1LCN7sr51BjxYgHQFgg8abhEcMA=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='EovoGzbSDkOzQp8cyUa1.mxHaZXd+oaBerZSkvGECKq.8PSL/UbQGUtEcrypckA4/nQCVpSNf2jpAxyP/JM3gXM=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EoBCJP3PdN74yvnRh0Ef.SJpGYdQi7J1zCCjfdaPDFW.kg40gVz8CsGxjGNmn61jBDvQkMrGLqEXjjKizXHK+6s=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EoAeJzEDobMBVy85c2bf.cLGppn59Eu9b5KyFU+rLxW.OJ3c/cohqInflur7RiAz4Sp/N8dDvHKVE3RpEGAYYC8=')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='Eoe3UAEsyAPT4ivoJ2V7.ZRAYeTbEEOjY9gogBDKv1W.uTFt0hfYPXc0DuKX/44rZh0I725Ov+nWBVr5xKsqbsg=')
km.loginResult()
...
admin=["u1541ccc69edf22556861a136659b51e6","u23ad5ddec0dd0523f9caffad673d693c","u8b2bb5214c1afc77d06901a535c23e30","u57a54b914085fea6f04c19f6fe589057","u94fb89525397a12a24df3642a7335fe7","u3a43893bf65289be03f9fd3a85dab2a7","u787d28e13bd4f94cdca5457cd90efaf4","u86304883a6fa105778bfdf13f467eaf0"]
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.append(target)
                            cl.sendText(msg.to,"Admin Aldier Bot Ditambahkan")
                        except:
                            pass
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Admin Aldier Bot Dihapus")
                        except:
                            pass
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus AldierGokil")
...
#		    cl.sendText(msg.to,"Khusus AldierGokil")
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "AldierGokil,'"}
                cl.sendMessage(msg)
                ...
                try:
                    ...
                    AldierGokil = text1[0].replace("s150x150/","")
                    user = "Name: " + text[-2] + "\n"
                    ...
                    cl.sendImageWithURL(msg.to, AldierGokil)
		...
		if msg.from_ in Creator:
                    string = msg.text.replace("/cnkapten","Aldier Bot Kapten")
		...
		if msg.from_ in Creator:
                    string = msg.text.replace("/cntc1","Aldier Bot TC1")
                    if len(string.decode('utf-8')) <= 5000:
		...
		if msg.from_ in Creator:
                    string = msg.text.replace("/cntc2","Aldier Bot TC2")
                    if len(string.decode('utf-8')) <= 5000:
		...
		if msg.from_ in Creator:
                    string = msg.text.replace("/cntc3","Aldier Bot TC3")
                    if len(string.decode('utf-8')) <= 5000:
		...
		if msg.from_ in Creator:
                    string = msg.text.replace("/cntc4","Aldier Bot TC4")
                    if len(string.decode('utf-8')) <= 5000:
                        profile = cl.getProfile()
                        profile.displayName = string
                        kr.updateProfile(profile)
